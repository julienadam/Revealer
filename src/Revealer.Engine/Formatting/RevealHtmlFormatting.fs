namespace Reveal.Formatting

// --------------------------------------------------------------------------------------
// F# Markdown (HtmlFormatting.fs)
// (c) Tomas Petricek, 2012, Available under Apache 2.0 license.
// Original found at https://github.com/fsprojects/FSharp.Formatting
// Modified by Julien Adam for use in Revealer to customize the HTML output
// --------------------------------------------------------------------------------------

module RevealHtmlFormatting = 
